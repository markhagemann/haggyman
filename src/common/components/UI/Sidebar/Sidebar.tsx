...
const mobileClass: (props: SidebarProps) => string = props => {
  return classNames({
    'border-gradient-b-blue-custom flex-col justify-center px-5 mt-24 md:w-75 md:fixed md:h-screen md:mt-0 md:border-r': true,
  ...
  return (
    <aside className={mobileClass(props)}>
      ...
      <div className="font-exo m-2 text-center">
        ...
        <h3 className="font-light text-blue-dark my-1 text-2xl"> Full Stack Developer </h3>
        <Social />
      </div>
    </aside>
  );
